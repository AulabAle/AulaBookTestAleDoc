<div>
    <div class="row justify-content-around">
        ...
        <div class="col-12 my-5 d-block d-sm-none"  wire:ignore>
            ...
            <div class="d-flex flex-wrap justify-content-center justify-content-lg-start align-items-center">
                <button class=" btn btn-primary mb-3" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" id="btnArrow">
                    Ricerca avanzata <i class="bi bi-funnel ms-2"></i><i class="bi bi-arrow-down" id="arrow"></i>
                </button>
            </div>
    
            <form class=" br-15 collapse" id="collapseExample">
                
                {{-- Ricerca --}}
                <div class="mb-3  padding-custom-20y-30x br-15">   
                    <h2 class="fw-bold mb-1 fs-3">Ricerca</h2>
                    <label for="inputSearch" class="form-label fw-bold"></label>
                    <input 
                        id="inputSearch" 
                        type="text" 
                        name="search" 
        ...
        {{-- utilizzo di wire:ignore per consentire ai filtri di rimanere sempre visibili --}}
        <div class="col-4 my-5  d-none d-sm-block"  wire:ignore>
    
            <form class=" padding-custom-20y-30x br-15 my-3">
